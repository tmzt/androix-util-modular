...
symlink_mesa_math() {
    ...
    dst_dir xserver/xorg/GL/mesa/math
...
symlink_mesa_ac() {
    ...
    dst_dir xserver/xorg/GL/mesa/array_cache
...
symlink_mesa_swrast() {
    ...
    dst_dir xserver/xorg/GL/mesa/swrast
...
symlink_mesa_ss() {
    ...
    dst_dir xserver/xorg/GL/mesa/swrast_setup
...
symlink_mesa_tnl() {
    ...
    dst_dir xserver/xorg/GL/mesa/tnl
...
symlink_mesa_shader() {
    ...
    dst_dir xserver/xorg/GL/mesa/shader
...
symlink_mesa_sparc() {
    ...
    dst_dir xserver/xorg/GL/mesa/sparc
}

symlink_mesa_x86() {
    src_dir src/mesa/x86
    dst_dir xserver/xorg/GL/mesa/x86
}

symlink_mesa_x8664() {
    src_dir src/mesa/x86-64
    dst_dir xserver/xorg/GL/mesa/x86-64
}
